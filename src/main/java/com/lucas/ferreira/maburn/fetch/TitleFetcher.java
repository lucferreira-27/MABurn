...
import com.lucas.ferreira.maburn.controller.ManualSearchAlertController;
...
public class TitleFetcher {
	...
	public TitleFetcher(CollectionTitle title, TextArea txtFetchMsg) {
	...
	public TitleScraped automaticFetch(Sites sourceSelect, TitleSearcher titleSearcher) throws Exception {
