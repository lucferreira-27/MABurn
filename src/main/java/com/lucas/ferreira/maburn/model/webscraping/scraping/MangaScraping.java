...
public class MangaScraping extends AutoBrowser  implements TitleScraping {
	
	private Sites site;
	public MangaScraping(Sites site, Playwright playwright) {
	...
	public TitleScraped scrapeTitle(String url) {
		...
		MangaScraped mangaScraped = new MangaScraped(url, site);
		mangaScraped.getItemsScraped().addAll(chapters);
		close();
		return mangaScraped;
